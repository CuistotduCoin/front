...
const CookForm: React.SFC<ICookFormProps> = ({ classes, values, action }) => (
	<Form autoComplete="off">
		<Grid container className={classes.grid}>
			...
			<Grid item xs={12}>
				<Field type="text" component={TextField} id="cook-description" label="Description" name="description" className={classes.textField} margin="normal" />
			</Grid>
			<Grid item xs={12}>
				<div className={classes.isPro}>
					<Field id="is_pro" name="is_pro" type="checkbox" checked={values.is_pro} component={Switch} />
			...
			{values.is_pro && (
				<>
					<Grid item xs={12}>
						<Field id="business_name" name="business_name" label="Nom de la société" className={classes.textField} margin="normal" type="text" component={TextField} />
					</Grid>
					<Grid item xs={12}>
						<Field type="text" component={TextField} id="siren" label="SIREN" name="siren" className={classes.textField} margin="normal" />
					</Grid>
					<Grid item xs={12}>
						<Field type="text" component={TextField} id="pro_email" label="Email pro." name="pro_email" className={classes.textField} margin="normal" />
					</Grid>
					<Grid item xs={12}>
						<Grid container>
							<Grid item xs={6}>
