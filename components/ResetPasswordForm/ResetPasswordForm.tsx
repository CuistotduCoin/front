...
export class ResetPasswordForm extends React.Component<IResetPasswordFormProps, {}> {
	...
	public onSubmit(openSnackbar) {
		return (values: IResetPasswordFormValues, { setSubmitting, setErrors, setStatus, resetForm }) => {
