...
export class ResetPasswordRequestForm extends React.Component<IResetPasswordRequestFormProps, {}> {
	...
	public onSubmit(openSnackbar) {
		return (values: IResetPasswordRequestFormValues, { setSubmitting, setErrors, setStatus, resetForm }) => {
