...
export class PaymentCardForm extends React.Component<IPaymentCardFormProps, IPaymentCardFormState> {
	...
	public render() {
		...
		const paymentCardFormComponent = (props: FormikProps<IPaymentCardFormValues>) => (
