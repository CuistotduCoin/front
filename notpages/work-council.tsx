	...
	public render() {
		...
		const steps = [
			{
				...
				title: 'Vous allez plaire',
				content: `Cuisiner est une activité accessible à tous et qui permet de partager des moments conviviaux tout en découvrant des saveurs d’ici et d’ailleurs, des savoir-faire authentiques et des recettes chargées d’histoire.`,
			},
			{
				icon: <EmoticonCool fontSize="large" />,
				title: 'Soyez serein',
				content: `Nous sélectionnons les ateliers les plus adaptés et nous nous chargeons de toute l’organisation. Les salariés participant aux ateliers n’ont plus qu’à se rendre aux fourneaux, à enfiler le tablier et à partager un moment convivial et savoureux !`,
			},
			{
				icon: <Charity fontSize="large" />,
				title: `Un accompagnement au top`,
				content: `Un membre de l’équipe reste à votre écoute sur la période des inscriptions aux ateliers. Il répond à toutes vos questions et s’assure du bon déroulé des ateliers.`,
			},
		];
        ...
        L’Atelier a été apprécié par tout le monde, que ce soit l’activité où la bonne humeur du cuistot. Les plats dégustés lors du repas en fin d’atelier étaient très bons.`,
			...
			},
			{
				...
				image: 'https://static.cuistotducoin.com/img/testimony/apacib.jpg',
				name: 'APACIB',
				rating: 5,
			},
		];
		...
		const pricing = [
			...
			},
			{
				...
				price: '65',
				description: [
					`3H d'atelier cuisine du monde ou technique`,
		...
		const photos = [
			...
			{
				src: 'https://static.cuistotducoin.com/img/work-council/atelier-sushi-maki.jpg',
				width: 1,
				height: 1,
				caption: 'Atelier sushi et maki',
				alt: 'Atelier sushi et maki',
			},
			{
				src: 'https://static.cuistotducoin.com/img/work-council/degustation-apres-atelier.jpg',
				width: 1,
				height: 1,
				caption: 'Dégustation après un atelier créole',
				alt: 'Dégustation après un atelier créole',
			},
		];
