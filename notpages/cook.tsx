							...
							<>
								...
								<div className={classes.container}>
									<div className={classes.cookProfile}>
										<ProfileImage imageKey={get(cook, 'gourmet.image.key')} identityId={cook.gourmet.identity_id} />
											...
											<Grid item>
												...
												<div>
													{workshops.map((workshop, i) => (
														<WorkshopListItem key={`Workshop${i}`} workshop={workshop} authorIdentityId={cookIdentityId} />
													))}
												</div>
											</Grid>
										)}
...
const enhance = compose(withStyles(styles as any), withRedirect);
