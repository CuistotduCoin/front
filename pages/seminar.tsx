		...
		>
			<Container maxWidth="lg">
				...
				<Typography variant="h5" align="justify" component="p" gutterBottom>
					Pour le petit déjeuner, la pause café ou encore le goûter, nous vous préparerons de délicieux assortiments de tapas sucrées. Et mettrons à disposition selon vos
					envies des jus de fruits artisanaux ou du thé/café biologique. Pour le midi et/ou le soir, nous vous préparerons des assortiments de tapas salées et sucrées
					pour des cocktails ou bien des repas à table selon vos envies. Les repas peuvent également être accompagné de vin de nos cavistes partenaires.
				</Typography>
				<Typography variant="h3" align="center" component="h2" gutterBottom>
				...
				<Typography variant="h5" align="justify" component="h3" gutterBottom>
					Nous avons une liste de lieux partenaires qui peuvent s'adapter à toutes les tailles de groupe. Nos lieux peuvent également disposer d'espaces de travail avec
					tout le nécessaire pour vos réunion.
				</Typography>
				<Typography variant="h3" align="center" component="h2" gutterBottom>
