...
class TeamBuilding extends React.Component<ITeamBuildingProps, {}> {
  public render() {
    ...
    const steps = [
      ...
      {
        icon: <ArrowDecision fontSize="large" />,
        title: "Une activité qui plait à tous",
        content:
    ...
    const photos = [
      {
        src:
          "https://static.cuistotducoin.com/img/teambuilding/ananas-flambe.jpg",
        width: 1,
        height: 1,
        caption: "Atelier en entreprise",
        alt: "Atelier en entreprise"
      },
      {
        src:
          "https://static.cuistotducoin.com/img/teambuilding/atelier-et-repas.jpg",
        width: 1,
        height: 1,
        caption: "Atelier suivi d'une repas convivial",
        alt: "Atelier et repas"
      },
      {
        src:
          "https://static.cuistotducoin.com/img/teambuilding/atelier-fraisier.jpg",
        width: 1,
        height: 1,
        caption: "Atelier patisserie : Fraisier",
        alt: "Atelier fraisier"
      },
      {
        src:
          "https://static.cuistotducoin.com/img/teambuilding/atelier-pasta.jpg",
        width: 1,
        height: 1,
        caption: "Atelier pasta",
        alt: "Atelier pasta"
      }
    ];
