...
export class Index extends React.Component<IIndexProps, IIndexState> {
  ...
  public render() {
    ...
    const photos = [
      { src: 'https://static.cuistotducoin.com/img/index/atelier-cacao.jpg', width: 1, height: 1, caption: "Atelier cacao", alt: "Atelier cacao" },
      { src: 'https://static.cuistotducoin.com/img/index/buffet-bresilien-3.jpg', width: 1, height: 1, caption: "Buffet-bresilien", alt: "Buffet bresilien" },
      { src: 'https://static.cuistotducoin.com/img/index/buffet-bresilien-1.jpg', width: 1, height: 1, caption: "Buffet-bresilien", alt: "Buffet bresilien" },
      { src: 'https://static.cuistotducoin.com/img/index/atelier-japonais.jpg', width: 1, height: 1, caption: "Atelier japonais", alt: "Atelier japonais" },
      { src: 'https://static.cuistotducoin.com/img/index/atelier-monde.jpg', width: 1, height: 1, caption: "Atelier monde", alt: "Atelier monde" },
      { src: 'https://static.cuistotducoin.com/img/index/atelier-cocktail.jpg', width: 1, height: 1, caption: "Atelier cocktail", alt: "Atelier cocktail" },
      { src: 'https://static.cuistotducoin.com/img/index/buffet-bresilien-2.jpg', width: 1, height: 1, caption: "Buffet-bresilien", alt: "Buffet bresilien" },
      { src: 'https://static.cuistotducoin.com/img/index/atelier-bresilien.jpg', width: 1, height: 1, caption: "Atelier bresilien", alt: "Atelier bresilien" },
    ];

    const productsB2B = [
      { title: 'Ateliers teambuilding', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cacao.jpg', link: '/teambuilding' },
      { title: 'Cocktails et réceptions', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/buffet-bresilien-1', link: '/cocktail-business' },
      { title: 'Pauses gourmandes', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cacao.jpg', link: '/breakfast' },
      { title: 'Déjeuner', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/cocktail-reseau-entreprendre.jpg', link: '/lunch' },
      { title: 'Evenement sur mesure', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cocktail.jpg', link: '/events-business' }
    ]

    const productsB2C = [
      { title: 'Ateliers privatifs', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cacao.jpg', link: '/individual#private' },
      { title: 'Cocktails et réceptions', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/buffet-bresilien-3.jpg', link: '/cocktail' },
      { title: 'Ateliers collectif', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cacao.jpg', link: '/individual#collective' },
      { title: 'Chef à domicile', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/privatechef.jpg', link: '/individual#privatechef' },
      { title: 'Evenement sur mesure', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/index/atelier-cocktail.jpg', link: '/events' }
    ]
