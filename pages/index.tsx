...
export class Index extends React.Component<IIndexProps, IIndexState> {
  ...
  public render() {
    ...
    const productsB2B = [
      ...
      { title: 'Cocktails et réceptions', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/home/buffet-bresilien-1', link: '/cocktail-business' },
      ...
      { title: 'Déjeuner', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/home/cocktail-reseau-entreprendre.jpg', link: '/lunch' },
    ...
    const productsB2C = [
      ...
      { title: 'Ateliers collectif', content: `Nous attachons une attention particulière à ce que nos créations soient de saison et que le goût soit au rendez-vous. Notre réseau de cavistes nous permet d’effectuer des accords mets et vins pour chaque événement à prix très compétitif. Vos invités ne retiendront qu’une chose : c’est délicieux.`, image: 'https://static.cuistotducoin.com/img/home/atelier-cacao.jpg', link: '/individual#collective' },
