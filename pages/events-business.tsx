...
export class Cocktail extends React.Component<ICocktailProps, {}> {
  public render() {
    ...
    const steps = [
      ...
      { icon: <HeartMultipleOutline fontSize="large" />, title: 'Activités fédératrices', content: "Réunion de travail, Séminaire, Atelier de cuisine... Faîtes-nous part du nombre d'invités que vous souhaitez réunir et du contexte de ces temps-forts et nous personnalisons nos propositions." },
    ...
    const stepsFAQ = [
      {
        ...
        content: `Indiquez-nous la date, l’heure et le nombre de collaborateurs que vous souhaitez réunir autour de votre événement. Précisez-nous le contexte de cet événement et le budget alloué à cette prestation. Indiquez-nous les saveurs qui vous inspirent ou laissez-nous vous faire la surprise !`
      },
      {
