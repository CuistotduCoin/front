...
class Individual extends React.Component<IIndividualProps, IIndividualState> {
  ...
  public render() {
    ...
    const workshops = [       
      ...
      {
        availableSeat: 8,
        date: "Samedi 21 Mars, 9h30-14h30",
        duration: 5,
        ...
        name: "Atelier Ayurvéda",
        nameCook: "Michel",
        price: 50,
        spot: "Plougastel",
        totalSeat: 8,
        typeform: "https://cuistotducoin.typeform.com/to/x1d7Vk",
        type: "Atelier collectif"
      },
      {
        availableSeat: 8,
      ...
      {
        availableSeat: 8,
        date: "Samedi 16 Mai, 10h00-12h00",
        duration: 2,
        image: "https://static.cuistotducoin.com/img/workshops/audrey-choux.jpg",
        imageCook: "https://static.cuistotducoin.com/img/cooks/audrey.jpg",
        name: "Atelier Enfants - Choux dans tous ses états",
        nameCook: "Audrey",
        price: 30,
        spot: "Cuisinella, Brest",
        totalSeat: 8,
