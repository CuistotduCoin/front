	...
	return (
		...
		>
			<Container>
				...
				<Typography variant="h5" align="justify" component="p" gutterBottom>
					Parrainez une autre entreprise ou un autre service et recevez des bons cadeaux sur vos prochaines prestations ! 50€ sur votre prochaine prestation ET 50€ offert
					sur la première prestation de votre filleul
				</Typography>
				<Typography variant="h3" align="center" component="h2" gutterBottom>
					La fidélité
				</Typography>
				<Typography variant="h5" align="justify" component="p" gutterBottom>
					A partir de Janvier, chaque client ayant réalisé une ou plusieurs prestations avec Cuistot du Coin aura un solde de points en fonction de vos achats. Vous
					obtenez 1 point tous les 1 euros dépensés (sur le montant hors taxe de vos prestations). Voici le programme avantage :
				</Typography>
				...
				<Typography variant="h5" align="justify" component="h3" gutterBottom>
					Vous ne connaissez pas votre solde de fidélité ? Envoyez-nous un mail à : anaelle@cuistotducoin.com
				</Typography>
			</Container>
		</Layout>
	);
